							...
							<tbody>
								...
								<tr>
									...
									<td class="">
										 ...
										 <p>ID - <b><?php echo ucwords($row['identification']) ?></b></p>
									</td>
									<td class="">
									...
									<button class="btn btn-sm btn-outline-primary view_movement" type="button" data-id="<?php echo $row['id'] ?>" >View</button>
...
<script>
	...
	$('.view_movement').click(function(){
		uni_modal("Receipt Details","view_movement.php?id="+$(this).attr('data-id'),'mid-large')
