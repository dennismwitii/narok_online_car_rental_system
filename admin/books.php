					...
					<div class="card-body">
						<table class="table table-condensed table-bordered table-hover">
							...
							<tbody>
								...
								$books = $conn->query("SELECT b.*,c.model,c.brand,c.price,c.transmission_id,c.engine_id FROM books b inner join cars c on c.id = b.car_id ");
								...
								<tr>
									...
									<td>
										 ...
										 <p>Price: <b><?php echo ucwords($row['price']) ?></b></p>
									</td>
									<td>
										<?php if($row['status'] == 1): ?>
